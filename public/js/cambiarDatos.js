...
for (let index = 0; index < document.getElementsByClassName("error").length; index++) {
    ...
    let contraAnterior = document.getElementById('contraseñaAnterior').value;
    ...
    if (contraAnterior === "" || contraAnterior === null) {
        document.getElementsByClassName("errorContraseñaAnterior")[0].innerHTML = "Debes rellenar el campo contraseña anterior";
        error = true;
    }
